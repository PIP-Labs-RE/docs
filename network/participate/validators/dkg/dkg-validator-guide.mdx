...
- If your kernel goes down, you miss the current round but **automatically rejoin** on the next one. Your validator continues producing blocks normally.
...
Your validator continues producing blocks. You miss the current DKG round but automatically rejoin on the next one.
