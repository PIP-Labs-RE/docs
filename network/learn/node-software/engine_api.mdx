...
The EL in the Data Foundation Network implements the following standard Engine API methods to support these functionalities:
...
How does the Data Foundation's Consensus Layer (CL) interact with these methods? The answer lies in CometBFT ABCI++.
...
This interaction ensures smooth coordination between the EL and the CL, maintaining the integrity and efficiency of the Data Foundation Network.