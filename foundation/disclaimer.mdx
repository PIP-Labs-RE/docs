---
title: Data Foundation Disclaimer
sidebarTitle: Disclaimers
icon: hand
---

The Foundation may directly or indirectly purchase and sell Data Foundation tokens ($DATA) at any time and
...
plans with respect to the sale and/or purchase of Data Foundation tokens. The volume, price, timing and
manner of any sales and purchases and other parameters will be determined by the Foundation in
its sole discretion. These transactions may involve the Foundation selling Data Foundation tokens at a price
(or at an average price) that is greater than the price (or the average price) at which the
Foundation purchases Data Foundation tokens in close proximity to one another or over time. This notice
does not obligate the Foundation to sell or purchase any specific amount of Data Foundation tokens or
