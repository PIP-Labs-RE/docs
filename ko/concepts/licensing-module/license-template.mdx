...
<CardGroup cols={2}>
  ...
  <Card title="PIL 스마트 컨트랙트" href="https://github.com/thedatafoundation/protocol-core-v1/blob/main/contracts/modules/licensing/PILicenseTemplate.sol" icon="scroll" color="#ccb092">
