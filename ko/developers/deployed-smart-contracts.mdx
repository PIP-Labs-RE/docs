---
title: 배포된 스마트 컨트랙트
description: 배포된 모든 프로토콜 주소 목록
---

## 코어 프로토콜 컨트랙트

- 컨트랙트는 GitHub [여기](https://github.com/thedatafoundation/protocol-core-v1/tree/main)에서 확인하세요
...
- 컨트랙트는 GitHub [여기](https://github.com/thedatafoundation/protocol-periphery-v1)에서 확인하세요
...
- 컨트랙트는 GitHub [여기](https://github.com/thedatafoundation/protocol-periphery-v1/tree/main/contracts/hooks)에서 확인하세요
...
아래 목록은 Royalty Module에서 사용할 수 있는 화이트리스트된 수익 토큰입니다.

<Tabs>
  <Tab title="Aeneid Testnet">
    | 토큰   | 컨트랙트 주소                                | 익스플로러                                                                                                                  | 발행                                                                                                                                                |
    | :----- | :------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------- |
    | WIP    | `0x1514000000000000000000000000000000000000` | [여기에서 보기 ↗️](https://aeneid.datanetscan.io/address/0x1514000000000000000000000000000000000000) | N/A                                                                                                                                                 |
    | MERC20 | `0xF2104833d386a2734a4eB3B8ad6FC6812F29E38E` | [여기에서 보기 ↗️](https://aeneid.datanetscan.io/address/0xF2104833d386a2734a4eB3B8ad6FC6812F29E38E) | [발행 ↗️](https://aeneid.datanetscan.io/address/0xF2104833d386a2734a4eB3B8ad6FC6812F29E38E?tab=write_contract#0x40c10f19) |
  </Tab>

  <Tab title="Mainnet">
    | 토큰  | 컨트랙트 주소                                | 익스플로러                                                                                                                  | 발행 |
    | :---- | :------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------- | :--- |
    | WIP   | `0x1514000000000000000000000000000000000000` | [여기에서 보기 ↗️](https://www.datanetscan.io/address/0x1514000000000000000000000000000000000000) | N/A  |
  </Tab>
</Tabs>
...
- **기본 라이선스 조건 ID** (Non-Commercial Social Remixing): 1
- **브리지된 USDC (Stargate)**: 0xF1815bd50389c46847f0Bda824eC8da914045D14

<Note>

DATA Foundation 메인넷에서는 위의 USDC만 지원합니다.
