...
For confidential data, the [🔒 CDR SDK](/developers/cdr-sdk/overview) (`@piplabs/cdr-sdk`) is the primary way to encrypt, store, and gate access to data on Story. Start with the [CDR SDK Guide](/developers/cdr-sdk/overview).
...
- Story's [🧱 Modules](/concepts/modules), like transparent on-chain [licensing](/concepts/licensing-module)
