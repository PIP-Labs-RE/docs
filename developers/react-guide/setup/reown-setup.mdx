...
description: Learn how to setup Reown (WalletConnect) in your DATA Foundation DApp.
---
...
1. Make sure to have `NEXT_PUBLIC_RPC_PROVIDER_URL` set up in your `.env` file.
   - You can use the public default one (`https://aeneid.datarpc.io`) or any other RPC [here](/network/network-info/aeneid#rpcs).
