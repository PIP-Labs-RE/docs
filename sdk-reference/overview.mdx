...
| <Icon icon="lock" iconType="solid" /> **CDR SDK** | Threshold encryption, confidential data vaults, and on-chain access control | [npm](https://www.npmjs.com/package/@piplabs/cdr-sdk) | |
...
The CDR SDK (`@piplabs/cdr-sdk`) provides a TypeScript client for Story's Confidential Data Recovery system. Use it to encrypt secrets using threshold cryptography, store them in on-chain vaults with configurable access control, and decrypt them by collecting partial decryptions from validators.
