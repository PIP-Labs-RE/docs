...
Install the [DATA Foundation SDK](https://www.npmjs.com/package/@story-protocol/core-sdk) node package, as well as [viem](https://www.npmjs.com/package/viem).
...
2. Make sure to have `RPC_PROVIDER_URL` set up in your `.env` file.
   - You can use the public default one (`https://aeneid.datarpc.io`) or check out the other RPCs [here](/network/network-info/aeneid#rpcs).
