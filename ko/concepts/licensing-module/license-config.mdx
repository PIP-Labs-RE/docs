...
<CardGroup cols={1}>
  <Card
    ...
    href="https://github.com/thedatafoundation/protocol-core-v1/blob/main/contracts/lib/Licensing.sol"
    icon="scroll"
    color="#ccb092"
  >
...
[LicensingModule.sol 컨트랙트](https://github.com/thedatafoundation/protocol-core-v1/blob/main/contracts/modules/licensing/LicensingModule.sol)에서 `setLicenseConfig` 함수를 호출하여 License Config를 설정할 수 있습니다.
