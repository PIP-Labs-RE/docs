...
description: Detailed overview of the DATA Network's staking mechanics and tokenomics
icon: sack-dollar
---
...
Note that all priority fees on the DATA Network go directly to the block proposer.
...
Slashing penalizes bad behaviors on the validators by slashing out a fraction of their staked tokens. Two types of behaviors can get slashed in the DATA Network: **double sign** and **downtime**.
