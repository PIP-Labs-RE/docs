...
A Security Council is an independent, semi-centralized group of trusted individuals or entities empowered to act swiftly to protect a decentralized protocol during emergencies. While decentralization is the ultimate goal of the Data Foundation, the council provides a pragmatic layer of operational security that can mitigate risks that decentralized governance cannot quickly address.

### 🛡️ Purpose and Core Responsibilities

The Security Council’s primary role is to safeguard the integrity of the Data Foundation Network and Data Foundation through technical oversight, by
...
- Integration with Data Foundation Proposals
  - Reviewing proposals (e.g., Data Foundation Proposals, forks, smart contract upgrades).
  - Writing Data Foundation Proposals
  - Issuing technical recommendations
- Review Data Foundation Proposals for technical feasibility
...
- Propose adjusting protocol parameters like:
  ...
  - Reserve rates for the $DATA token pool.
...
- Example of topics
  - Review of Data Foundation Proposals
...
- Members are empowered to carry out Emergency and Non-Emergency Actions, and ensure Data Foundation Proposals comply with the Constitution.
...
- Tokenholders gain the right to **elect a majority of Council Members** via a **Constitutional Data Foundation Proposal**.
...
- Tokenholders can remove Council Members via a **Constitutional Data Foundation Proposal**.
