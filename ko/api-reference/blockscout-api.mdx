...
description: "가스 가격, 평균 블록 시간, 시가총액, 토큰 가격 등을 조회합니다."
---

Datanetscan은 가스 가격, 평균 블록 시간, 시가총액, 토큰 가격(coin gecko) 및 기타 여러 통계를 반환하는 공개 API 엔드포인트를 제공합니다: `https://www.datanetscan.io/api/v2/stats`
