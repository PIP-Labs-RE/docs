...
description: DATA Foundation DApp에서 Reown (WalletConnect)을 설정하는 방법을 알아보세요.
---

<Note>
**선택 사항: 공식 WalletConnect 문서**

공식 Wagmi + Reown 설치 문서는 [여기](https://docs.walletconnect.com/appkit/next/core/installation)에서 확인할 수 있습니다.
...
2. `.env` 파일에 `NEXT_PUBLIC_WALLET_CONNECT_PROJECT_ID`가 설정되어 있는지 확인하세요. [Reown (이전 WalletConnect)](https://reown.com/)에 로그인하여 프로젝트를 생성하면 됩니다.
