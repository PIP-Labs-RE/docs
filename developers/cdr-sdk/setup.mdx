...
<Note>
  If you plan to mint Data Foundation license tokens in an IP-gated flow, also install
...
Every `CDRClient` requires an `apiUrl`: the base URL of a Data Foundation API REST
...
| Network | Data Foundation API REST URL          | Notes                                       |
| ------- | --------------------------- | ------------------------------------------- |
...
| Network | `network` param | Default RPC URL              | Data Foundation API REST URL          | Description               |
| ------- | --------------- | ---------------------------- | --------------------------- | ------------------------- |
| Aeneid  | `"testnet"`     | `https://aeneid.datarpc.io` | `http://172.192.41.96:1317` | Current supported release |
...
shared Data Foundation API endpoint or your own Story node's REST gateway.
...
<Note>
  ...
  with deployed condition contracts (such as the Data Foundation license-gated pattern
