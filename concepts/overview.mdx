...
The core module is the:

1. [📜 Licensing Module](/concepts/licensing-module): attach license terms to an IP Asset and mint **License Tokens** from it. These terms — and the tokens minted under them — are what define who can use an IP and, via [CDR](/developers/cdr-sdk/overview), who can decrypt data gated behind it.
