...
If you'd like to jump into code examples/tutorials, please see [How to Register IP on the Data Foundation](/developers/tutorials/how-to-register-ip-on-story).
