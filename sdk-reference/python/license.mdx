---
title: License
description: License allows you to manage license terms and tokens within the DATA Foundation.
---
...
- `currency`: The ERC20 token to be used to pay the minting fee and the token must be registered on the DATA Foundation's protocol.
