...
description: The DATA Foundation Programmable IP License - A legal framework for IP licensing on-chain
icon: capsules
---

The PIL is a legal off-chain document based on US copyright law created by the DATA Foundation team.
