...
| ------- | --------------- | ----------------- |
| Mainnet | v1.1.2 (Cosmas) | v1.4.2 (Terence) |
| Aeneid  | v1.1.2 (Cosmas) | v1.4.2 (Terence) |

- **`story-geth`execution client:**
  - Release Link: [**Click here**](https://github.com/piplabs/story-geth/releases)
  - Latest Stable Binary (v1.1.2): [**Click here**](https://github.com/piplabs/story-geth/releases/tag/v1.1.2)
...
```bash
cd $HOME
wget https://github.com/piplabs/story-geth/releases/download/v1.1.2/geth-linux-amd64
