...
For confidential data, [🔒 Confidential Data Rails (CDR)](/developers/cdr-sdk/overview) is the primary way to encrypt, store, and gate access to data on Story. Start with the [CDR SDK Guide](/developers/cdr-sdk/overview) (`@piplabs/cdr-sdk`).
...
- Story's [📜 Licensing Module](/concepts/licensing-module), enabling transparent on-chain licensing
