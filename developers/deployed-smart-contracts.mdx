...
- View contracts on our GitHub [here](https://github.com/thedatafoundation/protocol-core-v1/tree/main)
...
- View contracts on our GitHub [here](https://github.com/thedatafoundation/protocol-periphery-v1)
...
- View contracts on our GitHub [here](https://github.com/thedatafoundation/protocol-periphery-v1/tree/main/contracts/hooks)
...
The below list contains the whitelisted revenue tokens that can be used in the Royalty Module.

<Tabs>
  <Tab title="Aeneid Testnet">
    | Token  | Contract Address                             | Explorer                                                                                                                   | Mint                                                                                                                                                |
    | :----- | :------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------- |
    | WIP    | `0x1514000000000000000000000000000000000000` | [View here ↗️](https://aeneid.datanetscan.io/address/0x1514000000000000000000000000000000000000) | N/A                                                                                                                                                 |
    | MERC20 | `0xF2104833d386a2734a4eB3B8ad6FC6812F29E38E` | [View here ↗️](https://aeneid.datanetscan.io/address/0xF2104833d386a2734a4eB3B8ad6FC6812F29E38E) | [Mint ↗️](https://aeneid.datanetscan.io/address/0xF2104833d386a2734a4eB3B8ad6FC6812F29E38E?tab=write_contract#0x40c10f19) |
  </Tab>

  <Tab title="Mainnet">
    | Token | Contract Address                             | Explorer                                                                                                                   | Mint |
    | :---- | :------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------- | :--- |
    | WIP   | `0x1514000000000000000000000000000000000000` | [View here ↗️](https://www.datanetscan.io/address/0x1514000000000000000000000000000000000000) | N/A  |
  </Tab>
</Tabs>
...
We only support the above USDC on DATA Foundation's mainnet.
