...
The Foundation may directly or indirectly purchase and sell DATA tokens ($DATA) at any time and
...
plans with respect to the sale and/or purchase of $DATA. The volume, price, timing and
manner of any sales and purchases and other parameters will be determined by the Foundation in
its sole discretion. These transactions may involve the Foundation selling $DATA at a price
(or at an average price) that is greater than the price (or the average price) at which the
Foundation purchases $DATA in close proximity to one another or over time. This notice
does not obligate the Foundation to sell or purchase any specific amount of $DATA or
