---
title: Overview
description: List of all production-grade modules used on the DATA Network
---

# List of Modules

Here is a list of all production-grade modules that can be used on the DATA Network, along with their respective documentation:
...
The DATA Network uses the following Cosmos SDK modules with some modifications:
...
The DATA Network uses the following Cosmos SDK modules without non-trivial modifications:
