...
You can set the License Config by calling the `setLicenseConfig` function in the [LicensingModule.sol contract](https://github.com/thedatafoundation/protocol-core-v1/blob/main/contracts/modules/licensing/LicensingModule.sol).
