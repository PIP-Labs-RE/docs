...
Welcome to the DATA Foundation API Reference! See below for details.
...
| -------------- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| Mainnet        | `https://api.dataapis.io/api/v4`             | <Icon icon="arrow-up-right-from-square" iconType="solid" /> [Go](https://api.dataapis.io/api/v4/docs)             | <Icon icon="arrow-up-right-from-square" iconType="solid" /> [Go](https://api.dataapis.io/api/v4/openapi.json)             |
