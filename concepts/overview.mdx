---
title: Overview
description: A broad overview of the Data Foundation's "Proof-of-Creativity" protocol.
...
<Note>
  IP and licensing are the **rights layer** for data on the Data Foundation. The license
